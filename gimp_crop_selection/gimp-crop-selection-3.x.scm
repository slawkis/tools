...
;
(define (script-fu-crop-selection image source-drawable)
  (let* (
        ...
        (iWidth		(car (gimp-image-get-width image)))
        (iHeight	(car (gimp-image-get-height image)))
	...
	(gimp-edit-paste source-drawable TRUE)
